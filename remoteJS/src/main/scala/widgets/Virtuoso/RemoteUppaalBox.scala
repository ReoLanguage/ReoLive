...
/**
  * Created by guillerminacledou on 2019-09-30
  */


class RemoteUppaalBox(connector:Box[CoreConnector], errorBox:OutputArea)
  ...
  def showModel():Unit = {
    ...
    val lit = scalajs.js.Dynamic.literal(
      ...
      readOnly = true, theme = "default", gutter = true, cursorBlinkRate = -1, mode="application/xml")
